...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            page_sass: {
                files: [ '<%= pageBase %>/**/*.scss', '<%= pageBase %>/**/*.sass', './utils/**/*.scss', './utils/**/*.sass' ],
                tasks: [ 'compass:page', 'cssmin:page' ]
            },
            common_sass: {
                files: [ '<%= commonBase %>/**/*.scss', '<%= commonBase %>/**/*.sass', './utils/**/*.scss', './utils/**/*.sass' ],
    ...
    // 对单个页面进行打包
    grunt.registerTask('page', ['ktpl:page','kmc:page', 'uglify:page', 'css_combo:page', 'cssmin:page']);
    // 对common进行打包
    grunt.registerTask('common', ['ktpl:common', 'kmc:common', 'uglify:common', 'css_combo:common', 'cssmin:common']);
    // 静态资源代理 + watch
